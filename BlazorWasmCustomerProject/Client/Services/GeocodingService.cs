...
namespace BlazorWasmCustomerProject.Client.Services
{
    public class GeocodingService
    {
        ...
        {
            var reqUrl = $@"https://maps.googleapis.com/maps/api/geocode/json?address={address}&key=AIzaSyDS32xN824ZUWmspKCweEktIxP3TTAALwc";
